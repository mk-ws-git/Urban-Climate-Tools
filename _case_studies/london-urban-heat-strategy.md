---
layout: case-study
title: London, UK - Heat Risk Strategy & Cool Spaces
city: London
country: United Kingdom
year: 2023
sector: Heat Resilience & Public Health
description: London's cross-agency response to worsening summer heat, combining cool spaces, green roofs, and data-driven heat health alerts
...
image_url: /assets/images/london.svg
---
...
1. Early warning systems only save lives if they trigger pre-planned actions — building these protocols takes years
2. Mapping vulnerability explicitly prevents cool-space resources going to well-resourced areas
3. Green roofs require planning policy mandates to achieve scale — voluntary uptake is insufficient
4. Cross-agency co-ordination between health, environment and planning bodies is essential
