...
<section class="categories">
    <div class="categories__container">
        ...
        <div class="categories__grid">
            <a href="/categories/heat/" class="category-card">
            ...
            <a href="/categories/flood/" class="category-card">
                <div class="category-card__icon">
                    <svg viewBox="0 0 100 100">
            ...
            <a href="/categories/coastal/" class="category-card">
                <div class="category-card__icon">
                    <svg viewBox="0 0 100 100">
            ...
            <a href="/categories/green/" class="category-card">
                <div class="category-card__icon">
                    <svg viewBox="0 0 100 100">
            ...
            <a href="/categories/data/" class="category-card">
                <div class="category-card__icon">
                    <svg viewBox="0 0 100 100">
