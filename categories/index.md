    ...
    <div class="container">
        ...
        <div class="category-grid">
            ...
            <a href="{{ site.baseurl }}/categories/other/" class="category-card">
                ...
                <h3>Other Tools</h3>
                <p>Additional resources and specialized tools</p>
            </a>
        </div>
    </div>
</div>
...
<style>
    ...
    .category-card:hover {
        ...
        box-shadow: 0 8px 16px rgba(0, 81, 186, 0.2);
    }
    ...
    .category-card:hover .category-icon svg line,
    .category-card:hover .category-icon svg circle,
    .category-card:hover .category-icon svg ellipse {
